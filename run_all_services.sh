...
sudo ~/spark-2.4.4-bin-hadoop2.7/bin/spark-submit --class ru.otus.de.project.streamgeo.GeoStream ./streams/streamgeo/target/scala-2.11/streamgeo-assembly-0.1.jar &

sudo ~/spark-2.4.4-bin-hadoop2.7/bin/spark-submit --class ru.otus.de.project.streamsms.SmsStream ./streams/streamsms/target/scala-2.11/streamsms-assembly-0.1.jar &

sudo ~/spark-2.4.4-bin-hadoop2.7/bin/spark-submit --class ru.otus.de.project.streampayment.PaymentStream ./streams/streampayment/target/scala-2.11/streampayment-assembly-0.1.jar &
